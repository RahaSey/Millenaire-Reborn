...
public class WorldGenCherry extends WorldGenAbstractTree {
  ...
  public WorldGenCherry(boolean notify) {
    ...
    this.metaWood = Blocks.LOG.getDefaultState().withProperty((IProperty)BlockOldLog.VARIANT, (Comparable)BlockPlanks.EnumType.SPRUCE);
    this.metaLeaves = MillBlocks.CHERRY_LEAVES.getDefaultState().withProperty((IProperty)BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
  }
