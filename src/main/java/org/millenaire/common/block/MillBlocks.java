...
public class MillBlocks {
  ...
  public static void registerBlocks(RegistryEvent.Register<Block> event) {
    ...
    event.getRegistry().register((IForgeRegistryEntry)new BlockPath("pathochretiles", MapColor.BROWN_STAINED_HARDENED_CLAY, SoundType.STONE));
    event.getRegistry().register((IForgeRegistryEntry)new BlockPathSlab("pathochretiles", MapColor.BROWN_STAINED_HARDENED_CLAY, SoundType.STONE));
    ...
    event.getRegistry().register((IForgeRegistryEntry)new BlockMillStatue("feathered_serpent", SoundType.STONE, Material.ROCK));
    ...
    event.getRegistry().register((IForgeRegistryEntry)new BlockMillWallItem("mayan_calendar", Material.WOOD, SoundType.WOOD));
  }
