...
public class MillItems {
  ...
  static ItemArmor.ArmorMaterial ARMOUR_SELJUK_WOOL = EnumHelper.addArmorMaterial("seljukWoolArmour", "millenaire:seljuk_wool", 7, new int[] { 2, 5, 3, 1 }, 10, SoundEvents.BLOCK_CLOTH_PLACE, 0.0F);
